...
// that's a nice pizza size, hope is is not soggy

radius = 18;

const pizzaBites = Math.PI * radius ** 2;

const CheesyCrust = 2 * Math.PI * radius;

console.log("Pizza: "+pizzaBites);
console.log("Pizzacrust: "+CheesyCrust);