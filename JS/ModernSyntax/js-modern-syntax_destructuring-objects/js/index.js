...
const age = years;
console.log(Username,isAdmin,age);
...
console.log(dogAge,dogBreed,dogName);
...
const {lastName:personLastName, ...theRest} =person;
const moreInformation = theRest;
...
export function logInfo(city) {
  const {Cityname, country, population: numPeople} = city;
  //const name = city.name;
  //const country = city.country;
  //const numPeople = city.population;

  return `${Cityname} is in ${country} and has ${numPeople} inhabitants in it.`;
}
...
// Usage example:
console.log(
  logInfo({ Cityname: "Marseille", country: "France", population: 861635 })
);
